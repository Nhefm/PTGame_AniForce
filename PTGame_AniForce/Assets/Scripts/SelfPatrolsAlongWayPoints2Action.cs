...
[NodeDescription(name: "Self patrols along WayPoints 2", story: "[Agent] patrols along [WayPoints]", category: "Action/Navigation", id: "c8ff834b55a4e314b931cbd58cc6f7a2")]
public partial class SelfPatrolsAlongWayPoints2Action : Action
{
        ...
        protected override Status OnUpdate()
        {
            ...
            else
            {
                ...
                else if (m_NavMeshAgent == null)
                {
                    ...
                    toDestination.y = 0.0f; // Ignore vertical movement.
                    toDestination.Normalize();
                    agentPosition += toDestination * (speed * Time.deltaTime);
                    Agent.Value.transform.position = agentPosition;

                    // Flip sprite by adjusting the Y rotation based on the X direction.
